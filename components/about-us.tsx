      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              Nuestro compromiso es ofrecer piezas auténticas, sostenibles y asequibles que combinen estilo, confort y
              funcionalidad. Cada artículo es cuidadosamente seleccionado y restaurado para garantizar su calidad.
            </p>
